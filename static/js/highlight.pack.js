...
},contains:[E]},c,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}}());hljs.registerLanguage("dns",function(){"use strict";return function(d){return{
...
},d.inherit(d.NUMBER_MODE,{begin:/\b\d+[dhwm]?/})]}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
...
contains:b}}}());hljs.registerLanguage("haml",function(){"use strict";return function(e){return{
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"}}}());hljs.registerLanguage("python",function(){"use strict";return function(e){
const n={
...
relevance:0}]}}}());hljs.registerLanguage("csp",function(){"use strict";return function(e){return{
...
begin:"^Content",end:":",excludeEnd:!0}]}}}());hljs.registerLanguage("julia",function(){"use strict";return function(e){
...
excludeBegin:!0,end:t+":",relevance:0}],illegal:/#|<\//};var l}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("puppet",function(){"use strict";return function(e){
...
begin:"(\\b0[0-7_]+)|(\\b0x[0-9a-fA-F_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b",
relevance:0},n]}],relevance:0}]}}}());hljs.registerLanguage("lua",function(){"use strict";return function(e){
...
relevance:0}},{begin:"\\n\\n",starts:{subLanguage:[],endsWithParent:!0}}]}}}());hljs.registerLanguage("apache",function(){"use strict";return function(e){
